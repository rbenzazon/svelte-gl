...
class Menu extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$f, create_fragment$f, safe_not_equal, {}, add_css$9);
	}
}
...
class DebugBlock extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$e, create_fragment$e, safe_not_equal, {}, add_css$8);
	}
}
...
function add_css$7(target) {
	append_styles(target, "svelte-1ph32xs", "h2.svelte-1ph32xs{text-transform:uppercase;font-weight:bold;font-size:1rem;color:var(--panel-light-color);border-top:1px solid var(--panel-dark-color);border-bottom:1px solid var(--panel-dark-color);padding:4px 7px 2px 7px}");
}
...
class DebugH2 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$d, create_fragment$d, safe_not_equal, {}, add_css$7);
	}
}
...
function add_css$6(target) {
	append_styles(target, "svelte-1jp6dyh", "h3.svelte-1jp6dyh{text-transform:uppercase;font-size:0.9rem;color:var(--panel-light-color);border-top:1px solid var(--panel-dark-color);padding:5px 7px 2px 7px}h3.svelte-1jp6dyh:first-child{border-top:none}");
}
...
class DebugH3 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$c, create_fragment$c, safe_not_equal, {}, add_css$6);
	}
}
...
class DebugRow extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$a, create_fragment$a, safe_not_equal, {}, add_css$4);
	}
}
...
function add_css$3(target) {
	append_styles(target, "svelte-1xdiptw", "input[type=\"range\"].svelte-1xdiptw:focus{outline:none}input[type=\"range\"].svelte-1xdiptw{border-radius:5px;height:5px;outline:none;-webkit-appearance:none;appearance:none;flex:1}input[type=\"range\"].svelte-1xdiptw::-webkit-slider-runnable-track{height:var(--input-track-size);background-color:var(--panel-dark-color);border-radius:calc(var(--input-track-size) / 2)}input[type=\"range\"].svelte-1xdiptw:focus::-webkit-slider-runnable-track{background-color:var(--panel-dark-color)}input[type=\"range\"].svelte-1xdiptw::-moz-range-track{height:var(--input-track-size);background-color:var(--panel-dark-color);border-radius:calc(var(--input-track-size) / 2)}input[type=\"range\"].svelte-1xdiptw::-webkit-slider-thumb{border-radius:calc(var(--input-thumb-size) / 2);height:var(--input-thumb-size);width:var(--input-thumb-size);background:var(--input-thumb-color);cursor:pointer;-webkit-appearance:none;margin-top:calc((var(--input-track-size) - var(--input-thumb-size)) / 2)}input[type=\"range\"].svelte-1xdiptw::-moz-range-thumb{border:none;height:var(--input-thumb-size);width:var(--input-thumb-size);border-radius:calc(var(--input-thumb-size) / 2);background:var(--input-thumb-color);cursor:pointer}input[type=\"number\"].svelte-1xdiptw{flex:0.3;padding:3px 5px;color:var(--panel-light-color);background-color:var(--panel-dark-color);border:none;width:0}");
}
...
class DebugSliderNumber extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$9, create_fragment$9, safe_not_equal, { value: 0, min: 1, max: 2, step: 3 }, add_css$3);
	}
}
...
function add_css$2(target) {
	append_styles(target, "svelte-7xjpcd", "h4.svelte-7xjpcd{text-transform:capitalize;font-size:0.8rem;color:var(--panel-medium-color);padding:15px 7px 2px 7px;flex:1}");
}
...
class DebugH4 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$7, create_fragment$7, safe_not_equal, {}, add_css$2);
	}
}
...
// (47:4) {#each Object.entries(value).filter((p) => !(typeof p[1] === "function")) as [k, v]}
...
// (32:0) {#each Object.entries(get(material)) as [key, value]}
...
class DebugMaterial extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$3, create_fragment$3, safe_not_equal, { material: 0 });
	}
}
...
function add_css$1(target) {
	append_styles(target, "svelte-17v0ihe", "div.svelte-17v0ihe{display:grid;grid-template-columns:repeat(4, 1fr);gap:5px;padding:5px 40px}span.svelte-17v0ihe{color:var(--panel-light-color);background:var(--panel-dark-color)}");
}
...
function create_each_block$1(ctx) {
	...
	return {
		c() {
			span = element("span");
			t = text(t_value);
			attr(span, "class", "svelte-17v0ihe");
		},
		m(target, anchor) {
			insert(target, span, anchor);
			append(span, t);
...
class DebugMatrix extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$2, create_fragment$2, safe_not_equal, { matrix: 0 }, add_css$1);
	}
}
...
// (19:8) {#each Object.entries(attributes) as [key, value]}
...
function create_default_slot_1(ctx) {
	...
	return {
		...
		m(target, anchor) {
			...
			append(span, t4);
			insert(target, t5, anchor);
			mount_component(debugh33, target, anchor);
			insert(target, t6, anchor);
		...
		p(ctx, dirty) {
			...
			debugh32.$set(debugh32_changes);
			if ((!current || dirty & /*$meshes*/ 1) && t4_value !== (t4_value = /*drawMode*/ ctx[2] + "")) set_data(t4, t4_value);
		...
		d(detaching) {
			...
			destroy_component(debugblock, detaching);
			destroy_component(debugh32, detaching);
			destroy_component(debugh33, detaching);
...
// (14:2) {#each $meshes as { attributes, drawMode, matrix, material }
...
function add_css(target) {
	append_styles(target, "svelte-1vyde91", ".panel.svelte-1vyde91{font-family:Arial, sans-serif;position:absolute;top:0;right:0;width:350px;height:100%;overflow-y:auto;color:white;background-color:rgba(0, 0, 0, 0.8);--input-thumb-color:white;--input-track-color:#515151;--input-thumb-size:16px;--input-track-size:8px;--panel-dark-color:#515151;--panel-medium-color:#bdbdbd;--panel-light-color:#efefef}.panelContent.svelte-1vyde91{display:flex;flex-direction:column;justify-content:center;align-items:left;gap:10px;margin:50px 0px 20px 0px}.collapsed.svelte-1vyde91{display:none !important}.collapseButton.svelte-1vyde91{font-size:1.5rem;font-weight:bold;background:none;border:none;color:inherit;cursor:pointer;position:absolute;top:0;right:0;width:50px;height:50px}.openButton.svelte-1vyde91{background-color:rgba(0, 0, 0, 0.8);color:white;display:flex;justify-content:center;align-items:center;font-family:Arial, sans-serif}");
}
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "collapseButton openButton svelte-1vyde91");
			toggle_class(div0, "collapsed", !/*collapsed*/ ctx[0]);
			attr(button, "class", "collapseButton svelte-1vyde91");
			attr(div1, "class", "panelContent svelte-1vyde91");
			attr(div2, "class", "panel svelte-1vyde91");
