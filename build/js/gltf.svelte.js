...
import { l as loadGLTFFile, t as traverseScene, g as getAbsoluteNodeMatrix, c as createCameraFromGLTF, a as createMeshFromGLTF } from './gltf-loader-C25-s5ZV.js';
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		...
		set_store_value(scene, $scene = [...$scene, create3DObject(loadedMesh), light, light2], $scene);
