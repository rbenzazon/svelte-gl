import { S as SvelteComponent, i as init, s as safe_not_equal, a5 as append_styles, M as Menu, e as element, a as space, c as create_component, a6 as attr, b as insert, m as mount_component, a7 as listen, n as noop, t as transition_in, d as transition_out, f as detach, g as destroy_component, h as component_subscribe, o as onMount, j as scene, W as materials, r as renderer, l as lights, k as camera, y as set_store_value, z as skyblue, A as createLightStore, B as createPointLight, x as identity, X as createMaterialStore, C as create3DObject, D as createOrbitControls, Z as get_store_value, v as scale, w as translate, E as binding_callbacks } from './Menu-B4NHSdim.js';
import { c as createCube } from './cube-BOpy4bfn.js';
...
import { D as DebugPanel } from './DebugPanel-CB8p1DWX.js';

/* src\scene-update.svelte generated by Svelte v4.2.18 */

function add_css(target) {
	append_styles(target, "svelte-1u867qn", "button.svelte-1u867qn{position:absolute;top:100px;left:0}");
}
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			button.textContent = "add mesh";
			attr(button, "class", "svelte-1u867qn");
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = listen(button, "click", /*addMesh*/ ctx[1]);
				mounted = true;
			}
		},
		p: noop,
...
function instance($$self, $$props, $$invalidate) {
	...
	component_subscribe($$self, renderer, $$value => $$invalidate(8, $renderer = $$value));
	component_subscribe($$self, lights, $$value => $$invalidate(9, $lights = $$value));
	...
	return [canvas, addMesh, canvas_1_binding];
}
