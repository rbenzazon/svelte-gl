...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		...
		set_store_value(scene, $scene = [...$scene, create3DObject({ ...cubeMesh, matrix, material }), light], $scene);
