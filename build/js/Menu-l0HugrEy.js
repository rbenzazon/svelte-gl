...
function resetViewportToCanvas() {
	const { gl } = appContext;
...
function compileShaders(gl,program,vertexShaderSource,fragmentShaderSource) {
...
function createOrbitControls(canvas, camera) {
	...
	function onMouseMove(event) {
		...
		const newPolar = Math.max(0.01, Math.min(Math.PI - 0.01, polar - y / 100));
...
// (28:8) {#if window.location.pathname===link.href.substring(1)}
...
export { useProgram as $, set_store_value as A, skyblue as B, createLightStore as C, createPointLight as D, create3DObject as E, createOrbitControls as F, binding_callbacks as G, createMaterialStore as H, cross as I, subtract as J, normalize as K, drawModes as L, Menu as M, rotateY as N, rotateX as O, get_store_value as P, cloneMatrix as Q, appContext as R, SvelteComponent as S, compileShaders as T, getTranslation as U, createVec3 as V, orthoNO as W, lookAt as X, linkProgram as Y, validateProgram as Z, createFBO as _, space as a, selectProgram as a0, unbindTexture as a1, multiply as a2, fromRotationTranslationScale as a3, createFlatShadedNormals as a4, toRadian$1 as a5, ARRAY_TYPE as a6, lerp as a7, multiplyScalarVec3 as a8, normalizeNormals as a9, resetViewportToCanvas as aA, getCameraProjectionView as aB, invert as aC, defaultVertex as aD, templateLiteralRenderer as aa, append_styles as ab, attr as ac, listen as ad, run_all as ae, create_slot as af, toggle_class as ag, append as ah, update_slot_base as ai, get_all_dirty_from_scope as aj, get_slot_changes as ak, text as al, set_data as am, createEventDispatcher as an, null_to_empty as ao, hexNumToCSSStringColor as ap, linearArrayToCSSHashColor as aq, cssStringColorToHexNum as ar, ensure_array_like as as, empty as at, group_outros as au, check_outros as av, destroy_each as aw, cssStringColorToLinearArray as ax, create$1 as ay, createProgram as az, insert as b, create_component as c, transition_out as d, element as e, detach as f, destroy_component as g, component_subscribe as h, init as i, scene as j, materials as k, lights as l, mount_component as m, noop as n, onMount as o, camera as p, renderPasses as q, renderer as r, safe_not_equal as s, transition_in as t, transformMat4 as u, rotateZ as v, scale as w, translate as x, identity as y, createZeroMatrix as z };
