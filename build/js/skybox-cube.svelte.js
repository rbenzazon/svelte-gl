...
/* src\skybox-cube.svelte generated by Svelte v4.2.18 */
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(async () => {
		...
		const skyBox = await createSkyBox({
			url: "skybox-flamingo-tonemapped.png",
...
class Skybox_cube extends SvelteComponent {
	constructor(options) {
		super();
