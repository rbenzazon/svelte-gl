...
function add_css$4(target) {
	append_styles(target, "svelte-qjb2oz", "h4.svelte-qjb2oz{text-transform:capitalize;font-size:0.8rem;color:var(--panel-medium-color);padding:1px 0px 2px 0px;flex:1}.padding0.svelte-qjb2oz{padding-left:0px}.padding1.svelte-qjb2oz{padding-left:7px}.padding2.svelte-qjb2oz{padding-left:14px}.padding3.svelte-qjb2oz{padding-left:21px}");
}
...
function create_fragment$8(ctx) {
	...
	return {
		c() {
			h4 = element("h4");
			if (default_slot) default_slot.c();
			attr(h4, "class", h4_class_value = "" + (null_to_empty('padding' + /*padding*/ ctx[0]) + " svelte-qjb2oz"));
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*padding*/ 1 && h4_class_value !== (h4_class_value = "" + (null_to_empty('padding' + /*padding*/ ctx[0]) + " svelte-qjb2oz"))) {
...
// (50:4) {#each Object.entries(value).filter((p) => !(typeof p[1] === "function")) as [k, v]}
...
// (34:0) {#each Object.entries(get(material)) as [key, value]}
