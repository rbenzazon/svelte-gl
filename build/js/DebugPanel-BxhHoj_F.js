...
function add_css$5(target) {
	append_styles(target, "svelte-n3sif", "input[type=\"range\"].svelte-n3sif:focus{outline:none}input[type=\"range\"].svelte-n3sif{border-radius:5px;height:5px;outline:none;-webkit-appearance:none;appearance:none;flex:1}input[type=\"range\"].svelte-n3sif::-webkit-slider-runnable-track{height:var(--input-track-size);background-color:var(--panel-dark-color);border-radius:calc(var(--input-track-size) / 2)}input[type=\"range\"].svelte-n3sif:focus::-webkit-slider-runnable-track{background-color:var(--panel-dark-color)}input[type=\"range\"].svelte-n3sif::-moz-range-track{height:var(--input-track-size);background-color:var(--panel-dark-color);border-radius:calc(var(--input-track-size) / 2)}input[type=\"range\"].svelte-n3sif::-webkit-slider-thumb{border-radius:calc(var(--input-thumb-size) / 2);height:var(--input-thumb-size);width:var(--input-thumb-size);background:var(--input-thumb-color);cursor:pointer;-webkit-appearance:none;margin-top:calc((var(--input-track-size) - var(--input-thumb-size)) / 2)}input[type=\"range\"].svelte-n3sif::-moz-range-thumb{border:none;height:var(--input-thumb-size);width:var(--input-thumb-size);border-radius:calc(var(--input-thumb-size) / 2);background:var(--input-thumb-color);cursor:pointer}input[type=\"number\"].svelte-n3sif{flex:0.3;padding:3px 5px;color:var(--panel-light-color);background-color:var(--panel-dark-color);border:none;border-radius:0.3125rem;width:0}");
}
...
function add_css$4(target) {
	append_styles(target, "svelte-193j3ti", "h4.svelte-193j3ti{text-transform:capitalize;font-size:0.7rem;color:var(--panel-medium-color);padding:1px 0px 2px 0px;flex:1}.padding0.svelte-193j3ti{padding-left:0px}.padding1.svelte-193j3ti{padding-left:7px}.padding2.svelte-193j3ti{padding-left:14px}.padding3.svelte-193j3ti{padding-left:21px}");
}
...
function create_fragment$8(ctx) {
	...
	return {
		c() {
			h4 = element("h4");
			if (default_slot) default_slot.c();
			attr(h4, "class", h4_class_value = "" + (null_to_empty("padding" + /*padding*/ ctx[0]) + " svelte-193j3ti"));
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*padding*/ 1 && h4_class_value !== (h4_class_value = "" + (null_to_empty("padding" + /*padding*/ ctx[0]) + " svelte-193j3ti"))) {
...
// (48:8) {#each Object.entries(value).filter((p) => !(typeof p[1] === "function")) as [k, v]}
...
// (32:2) {#each Object.entries(get(material)) as [key, value]}
...
function add_css(target) {
	append_styles(target, "svelte-138zoog", ".panel.svelte-138zoog{font-family:Arial, sans-serif;position:absolute;top:0;right:0;width:350px;height:100%;overflow-y:auto;color:white;background-color:var(--panel-darkest-color);--input-thumb-color:white;--input-track-color:#515151;--input-thumb-size:16px;--input-track-size:8px;--panel-darkest-color:#252525;--panel-dark-color:#393939;--panel-medium-color:#777777;--panel-medium-light-color:#b7b7b7;--panel-light-color:#efefef;--panel-vertical-padding:7px;--panel-horizontal-padding:5px}.panelContent.svelte-138zoog{display:flex;flex-direction:column;justify-content:center;align-items:left;gap:0px;margin:50px 0px 20px 0px}.collapsed.svelte-138zoog{display:none !important}.collapseButton.svelte-138zoog{font-size:1.5rem;font-weight:bold;background:none;border:none;color:inherit;cursor:pointer;position:absolute;top:0;right:0;width:50px;height:50px}.openButton.svelte-138zoog{background-color:rgba(0, 0, 0, 0.8);color:white;display:flex;justify-content:center;align-items:center;font-family:Arial, sans-serif}");
}
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(div0, "class", "collapseButton openButton svelte-138zoog");
			toggle_class(div0, "collapsed", !/*collapsed*/ ctx[0]);
			attr(button, "class", "collapseButton svelte-138zoog");
			attr(div1, "class", "panelContent svelte-138zoog");
			attr(div2, "class", "panel svelte-138zoog");
